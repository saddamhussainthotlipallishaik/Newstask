    ...
    <b-row>
      ...
      >
        <b-card
          ...
          class="text-center card-section"
        >
          <div class="alert alert-danger" v-if="error">
            Opps!!! User Already Exits.
          </div>
  ...
  methods: {
    ...
    check(type) {
      ...
      if (type === "password") {
        ...
        result
          ? (this.passwordErr = "")
          : (this.passwordErr = "please enter valid password");
      }
      if (type === "cpassword") {
